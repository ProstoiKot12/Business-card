        ...
        new_cases.append(
            {
                ...
                "outcome": "Операционные процессы собраны в одну систему — менеджеры видят задачи в Telegram, а руководство получает ежедневную аналитику без ручного сбора данных.",
        ...
        new_cases.append(
            {
                ...
                "type": "Бот-сервис",
                "task": "Автоматизировать весь цикл — от заявки клиента до выезда мастера и оплаты: расчёт стоимости, бронирование, оплата, геолокация и CRM.",
                ...
                "outcome": "1700+ заказов обработано за полтора года в production. Клиент проходит путь от заявки до оплаты без менеджера, мастер — ведёт работу через Telegram.",
